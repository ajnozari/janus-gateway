...
// the whole session.
//
var server = "wss://<yoururl>/janus-ws";

var janus = null;
var sfutest = null;
var opaqueId = "videoroomtest-"+Janus.randomString(12);

var myroom = 2768356249109265;	// Demo room
var roompin = "YO96K9";
var myusername = null;
var myid = null;
var mystream = null;
						...
						janus.attach(
							{
								...
								webrtcState: function(on) {
									...
									$('#bitrate a').click(function() {
										...
										sfutest.send({"message": { "request": "configure", "bitrate": bitrate, pin: roompin }});
										return false;
									});
								},
...
function registerUsername() {
	if($('#username').length === 0) {
		...
		var register = { "request": "join", "room": myroom, "pin": roompin, "ptype": "publisher", "display": username,};
		myusername = username;
	...
	sfutest.createOffer(
		{
			...
			success: function(jsep) {
				...
				sfutest.send({"message": publish, "jsep": jsep, pin: roompin});
			},
			error: function(error) {
	...
	janus.attach(
		{
			...
			success: function(pluginHandle) {
				...
				var subscribe = { "request": "join", "room": myroom, "pin": roompin, "ptype": "subscriber", "feed": id, "private_id": mypvtid };
