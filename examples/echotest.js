...
// the whole session.
//
var server = "wss://" + window.location.hostname + "/janus";
			...
			janus = new Janus(
				{
                    ...
                    iceServers: [{urls: "stun:tippindev.com:5349", username: "ajnozari", credential: "8BrBQffgdFHoFRQDucvZ"},{urls: "turn:tippindev.com:5349", username: "ajnozari", credential: "8BrBQffgdFHoFRQDucvZ"}],
					success: function() {
